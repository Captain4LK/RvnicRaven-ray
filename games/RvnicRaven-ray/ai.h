...
typedef enum
{
   ...
   AI_STATE_ROCK0_IDLE,
   AI_STATE_ROCK1_IDLE,
   AI_STATE_CORPSE0_IDLE,
   AI_STATE_CORPSE1_IDLE,
   AI_STATE_CORPSE2_IDLE,
   AI_STATE_CORPSE3_IDLE,
   AI_STATE_CORPSE4_IDLE,
   AI_STATE_CORPSE5_IDLE,
   AI_STATE_CORPSE6_IDLE,
   AI_STATE_CORPSE7_IDLE,
   AI_STATE_GARGOYLE_IDLE,
